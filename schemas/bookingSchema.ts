...
export const bookingSchema = z.object({
  propertyId: z.string().nonempty("Property ID is required"), // Ensures non-empty string
  date: z.date(), // Ensures non-empty string
  time: z.string().nonempty("Time is required"), // Ensures non-empty string
  userId: z.string().nonempty("User ID is required"), // Ensures non-empty string
