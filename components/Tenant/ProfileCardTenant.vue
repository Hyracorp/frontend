                ...
                <Card class="" :pt="{ 'root': 'shadow-xl' }">
                    <template #title>
                        <div class="relative rounded-lg overflow-hidden justify-center items-center text-center">
                            <Image class="rounded-2xl" src="https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg=" alt="Image" style="max-width: 50%; max-height: 50%;"/>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm font-medium text-gray-500">Tenant Profile</p>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-4">
                            <Button label="Submit" @click="scrollToTarget('roommatesDivision')" class="flex items-center" outlined >
                                <Icon name="akar-icons:people-group" class="ml-1 mr-1 w-6 h-6"/>
                                    Room Mates
                             </Button>
                        </div>
                        <div class="flex flex-col gap-2 mt-4">
                        ...
                        <div class="flex flex-col gap-2 mt-4">
                            <Button label="Submit" @click="scrollToTarget('rentsDivision')" class="flex items-center" outlined >
                                <Icon name="icon-park-solid:agreement" class="ml-1 mr-1 w-6 h-6"/>
                                    View Rent Agreement
                             </Button>
                        </div>
                        <div class="flex flex-col gap-2 mt-4">
        ...
        <div class="w-[100%] flex-1 p-5 items-center">
            ...
            <Card id="profileDivision" class="mt-10" :pt="{ 'root': 'shadow-xl' }">
                                                ...
                                                <div>
                                                    <div class="relative card flex justify-center">
                                                        <div class="flex flex-col gap-2 w-full">
                                                            ...
                                                            <small id="location-help">Gender</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div>
                                                    <div class="relative card flex justify-center">
                                                        <div class="flex flex-col gap-2 w-full">
                                                            ...
                                                            <small id="location-help">Marital Status</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <small id="rent-help">Permanant Address</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <small id="rent-help">Birthday</small>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="flex flex-col gap-2">
                                                        <div class="hidden sm:flex justify-between">
                                                            <div class="w-full">
                                                                <div class="flex flex-col gap-2">
                                                                    ...
                                                                    <small id="property-spec-help">ID Proof</small>
                                                                </div>
                                                            </div>
                                                            <div class="ml-4 items-center">
                                                                <div class="flex items-center text-white">
                                                ...
                                                <div>
                                                    <div class="flex flex-col gap-2">
                                                        <div class="hidden sm:flex justify-between">
                                                            <div class="w-full">
                                                                <div class="flex flex-col gap-2">
                                                                    <InputText v-model="photoValue1" placeholder="Pancard"/>
                                                                    <small id="property-spec-help">Pancard</small>
                                                                </div>
                                                            </div>
                                                            <div class="ml-4 items-center">
                                                                <div class="flex items-center text-white">
                ...
                <template #content class="flex flex-col">
                    ...
                    <!-- Eleventh card -->
                    <div class="flex items-start justify-between mr-64">
                        <h6 class="text-gray-500">Pancard</h6>
                        <div class="flex flex-1 items-end justify-end mr-64">
                            <a type="submit" @click="showCard = !showCard" class="text-blue-600">+ Add</a>
                        </div>
                    </div>
            ...
            <!-- Room-mates -->
            <Card id="roommatesDivision" class="mt-10" :pt="{ 'root': 'shadow-xl' }">
                <template #title class="text-gray-500 flex flex-col">
                    <div class="flex items-center justify-between">
                        <div>
                            Room-Mates
                            <p class="text-sm font-medium text-gray-500">Enter all of your room-mates</p>
                        </div>
                        <form class="flex flex-col gap-3 justify-center items-center" @submit.prevent="() => {
                                console.log('form submitted');
                            }">
                        </form>
                        <Button type="submit" @click="showRoommateCard = !showRoommateCard" severity="info" outlined>
                            <Icon name="material-symbols:edit-outline" class="ml-1 mr-1 w-6 h-6"/>Add a Roommate
                        </Button>
                        <div v-if="showRoommateCard" class="fixed inset-0 overflow-y-auto bg-black bg-opacity-50 z-50 pt-10 pb-10">
                                <div class="flex justify-center items-center min-h-screen">
                                    <div class="bg-white p-8 rounded-lg shadow-xl max-w-[90%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] xl:max-w-[50%] w-full">
                                        <div class="mb-4">
                                        ...
                                        <div class="mt-6 flex justify-end">
                                            <Button @click="showRoommateCard = false" class="mr-4">Cancel</Button>
                ...
                <template #content class="flex flex-col">
                    ...
                    <!-- First card -->
                    <div class="flex items-start justify-between mr-64">
                        <h6 class="text-gray-500">Room-mate 01</h6>
                        <div class="flex flex-1 items-end justify-end mr-64">
            ...
            <Card id="reportsDivision" class="mt-10" :pt="{ 'root': 'shadow-xl' }">
                ...
                <template #content class="flex flex-col">
                    ...
                    <!-- First card -->
                    <div class="flex items-start justify-between mr-64">
                        <h6 class="text-gray-500">2023 - 2024 ( Current )</h6>
                        <div class="flex flex-1 items-end justify-end mr-64">
                    ...
                    <!-- Second card -->
                    <div class="flex items-start justify-between mr-64">
                        <h6 class="text-gray-500">2022 - 2023</h6>
                        <div class="flex flex-1 items-end justify-end mr-64">
                            <a href="" class="text-blue-600 items-end justify-end">View Report</a>
                        </div>
                    </div>
            ...
            <!-- Rent Agreement -->
            <Card id="rentsDivision" class="mt-10" :pt="{ 'root': 'shadow-xl' }">
                <div class="line"></div>
                <template #title class="text-gray-500 flex flex-col">
                    <div class="flex items-center justify-between">
                        <div>
                            View Your Rent Agreement
                            <p class="text-sm font-medium text-gray-500">View/Print your Rent Agreement</p>
                        </div>
                    </div>
                </template >
                ...
                <template #content class="flex flex-col">
                    ...
                    <div class="flex items-start justify-between mr-64">
                        <h6 class="text-gray-500">2023 - 2024 ( Current )</h6>
                        <div class="flex flex-1 items-end justify-end mr-64">
                            <a href="" class="text-blue-600 items-end justify-end">View Agreement</a>
                        </div>
                    </div>
                    <hr class="w-full mt-2 mb-5 border-t border-gray-300">
