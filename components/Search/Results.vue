  ...
  <div class="max-w-screen">
    <DataView v-if="results.length > 0" :dataKey="'id'" :value="results" layout="grid" :sortOrder="sortOrder"
      ...
      <template #header>
        ...
        <div class="max-w-7xl mx-auto flex gap-2 flex-wrap justify-left">
