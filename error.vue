...
<template>
  <div class="h-screen w-screen flex justify-center items-center flex-col bg-blue-100 p-5">
    <svg version="1.1" id="error-404-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      x="0px" y="0px" viewBox="0 0 344.7 276.7" style="enable-background: new 0 0 344.7 276.7" xml:space="preserve">
      <g id="decorations">
    ...
    <NuxtLink to="/" class="mt-5"><Button type="button" class="p-1 py-3" ><Icon name="ph:arrow-left" class="text-3xl" /> Go Back Home</Button></NuxtLink>
  </div>
</template>
